...
INSERT INTO description(item_num, item_desc) VALUES
	(54444, 'Paramount Apricot Flavored Brandy'),
	(82636, 'Dekuyper Grape Pucker Schnapps'),
	(80458, 'Ryans Cream Liqueur'),
	(69636, 'Dr. Mcgillicuddys Cherry Schnapps'),
...
INSERT INTO details(invoice, item_num, volume, quantity, cost, retail) VALUES
	('S24137900083', 54444, 375, 4, 3.55, 5.33),
	('S27519400019', 82636, 750, 2, 6.30, 9.45),
	('S22395800022', 80458, 1750, 6, 10.54, 16.31),
	('INV-06082600024', 69636, 750, 2, 8.66, 12.99),
	('S08806800029', 65256, 750, 2, 12.04, 18.06);
